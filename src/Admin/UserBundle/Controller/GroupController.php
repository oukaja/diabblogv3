...
class GroupController extends ContainerAware
{
    ...
    public function listAction()
    {
        ...
        return $this->container->get('templating')->renderResponse('AdminUserBundle:Group:list.html.'.$this->getEngine(), array('groups' => $groups));
    }
    ...
    public function showAction($groupname)
    {
        ...
        return $this->container->get('templating')->renderResponse('AdminUserBundle:Group:show.html.'.$this->getEngine(), array('group' => $group));
    }
    ...
    public function editAction($groupname)
    {
        ...
        return $this->container->get('templating')->renderResponse('AdminUserBundle:Group:edit.html.'.$this->getEngine(), array(
    ...
    public function newAction()
    {
        ...
        return $this->container->get('templating')->renderResponse('AdminUserBundle:Group:new.html.'.$this->getEngine(), array(
            'form' => $form->createview(),
        ));
    }
